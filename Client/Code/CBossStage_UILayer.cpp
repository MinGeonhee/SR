...
CBossStage_UILayer::CBossStage_UILayer()
{

}

HRESULT CBossStage_UILayer::Ready_Layer(LPDIRECT3DDEVICE9 pGraphicDev)
{
...
_int	CBossStage_UILayer::Update_Layer(const _float& fTimeDelta)
{
...
void	CBossStage_UILayer::LateUpdate_Layer(const _float& fTimeDelta)
{
    CCameraManager::GetInstance()->LateUpdate_UICamera(fTimeDelta);
    CUIManager::GetInstance()->LateUpdate_UI(fTimeDelta);
}

void	CBossStage_UILayer::Render_Layer()
{

}

CBossStage_UILayer* CBossStage_UILayer::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
    CBossStage_UILayer* pStUI = new CBossStage_UILayer();
