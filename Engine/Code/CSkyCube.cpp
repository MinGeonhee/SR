...
CSkyCube::CSkyCube(const CSkyCube& rhs)
    :CVIBuffer(rhs)
{
...
void CSkyCube::Render_Buffer()
{
    CVIBuffer::Render_Buffer();
}

CComponent* CSkyCube::Clone()
{
...
{
    CSkyCube* pCubeTex = new CSkyCube(pGraphicDev);
