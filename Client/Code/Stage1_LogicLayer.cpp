...
Stage1_LogicLayer::Stage1_LogicLayer()
{

}


HRESULT Stage1_LogicLayer::Ready_Layer(LPDIRECT3DDEVICE9 pGraphicDev)
{
...
_int	Stage1_LogicLayer::Update_Layer(const _float& fTimeDelta)
{
...
void	Stage1_LogicLayer::LateUpdate_Layer(const _float& fTimeDelta)
{
    CLayer::LateUpdate_Layer(fTimeDelta);
}

void	Stage1_LogicLayer::Render_Layer()
{

}

Stage1_LogicLayer* Stage1_LogicLayer::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
    Stage1_LogicLayer* pPlayer = new Stage1_LogicLayer();
