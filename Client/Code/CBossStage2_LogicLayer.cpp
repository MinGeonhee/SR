...
CBossStage2_LogicLayer::CBossStage2_LogicLayer()
{

}


HRESULT CBossStage2_LogicLayer::Ready_Layer(LPDIRECT3DDEVICE9 pGraphicDev)
{
...
_int	CBossStage2_LogicLayer::Update_Layer(const _float& fTimeDelta)
{
...
void	CBossStage2_LogicLayer::LateUpdate_Layer(const _float& fTimeDelta)
{
    CLayer::LateUpdate_Layer(fTimeDelta);
}

void	CBossStage2_LogicLayer::Render_Layer()
{

}

CBossStage2_LogicLayer* CBossStage2_LogicLayer::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
    CBossStage2_LogicLayer* pPlayer = new CBossStage2_LogicLayer();
...
void CBossStage2_LogicLayer::Free()
{
    CLayer::Free();
}