...
void ICam_FirstPerson::Enter(CCamera* pCamera, _vec3 vPos, _vec3 vTargetPos, float Distance, float fSpeed)
{
...
void ICam_FirstPerson::Update(CCamera* pCamera, CGameObject* pOwner, _float fDeltaTime)
{
	if (pOwner == nullptr)
		return;
...
void ICam_FirstPerson::Exit(CCamera* pCamera, CGameObject* pOwner)
{

}

void ICam_FirstPerson::Set_eye(CCamera* pCamera, CGameObject* pOwner)
{
...
void ICam_FirstPerson::Set_Look(CCamera* pCamera, CGameObject* pOwner)
{
	// 현재 내 눈 위치의 바로 앞을 봄.
	_vec3 pOwnerUp, pOwnerLook;
	pOwner->Get_Transform()->Get_Info(INFO_UP, &pOwnerUp);
...
void ICam_FirstPerson::Set_Matview(CCamera* pCamera, CGameObject* pOwner)
{
	_matrix MatView;
...
void ICam_FirstPerson::Set_MatProj(CCamera* pCamera, CGameObject* pOwner)
{
	_matrix MatProj;
