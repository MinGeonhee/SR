...
CParticleSystem_Book::CParticleSystem_Book(const CParticleSystem_Book& rhs)
    :CParticleSystem(rhs)
{

}

CParticleSystem_Book::CParticleSystem_Book(LPDIRECT3DDEVICE9 pGraphicDev)
    :CParticleSystem(pGraphicDev)
{
}

CParticleSystem_Book::~CParticleSystem_Book()
{
}

HRESULT CParticleSystem_Book::Ready_GameObject()
{
...
_int CParticleSystem_Book::Update_GameObject(const _float& fTimeDelta)
{
...
void CParticleSystem_Book::LateUpdate_GameObject(const _float& fTimeDelta)
{
    // 뒤로 들어가야함
    CParticleSystem::LateUpdate_GameObject(fTimeDelta);
}

void CParticleSystem_Book::Render_GameObject()
{
    // 뒤로 들어가야함
    CParticleSystem::Render_GameObject();
}

HRESULT CParticleSystem_Book::Add_Component()
{
...
CParticleSystem_Book* CParticleSystem_Book::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
    CParticleSystem_Book* pPS = new CParticleSystem_Book(pGraphicDev);
...
void CParticleSystem_Book::Make_And_Apply_Values_To_Particle()
{
...
void CParticleSystem_Book::Free()
{
