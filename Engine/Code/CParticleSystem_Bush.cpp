...
CParticleSystem_Bush::CParticleSystem_Bush(const CParticleSystem_Bush& rhs)
    :CParticleSystem(rhs)
{

}

CParticleSystem_Bush::CParticleSystem_Bush(LPDIRECT3DDEVICE9 pGraphicDev)
    :CParticleSystem(pGraphicDev)
{
}

CParticleSystem_Bush::~CParticleSystem_Bush()
{
}

HRESULT CParticleSystem_Bush::Ready_GameObject()
{
...
_int CParticleSystem_Bush::Update_GameObject(const _float& fTimeDelta)
{
...
void CParticleSystem_Bush::LateUpdate_GameObject(const _float& fTimeDelta)
{
    // 뒤로 들어가야함
    CParticleSystem::LateUpdate_GameObject(fTimeDelta);
}

void CParticleSystem_Bush::Render_GameObject()
{
    // 뒤로 들어가야함
    CParticleSystem::Render_GameObject();
}

HRESULT CParticleSystem_Bush::Add_Component()
{
...
CParticleSystem_Bush* CParticleSystem_Bush::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
    CParticleSystem_Bush* pPS = new CParticleSystem_Bush(pGraphicDev);
...
void CParticleSystem_Bush::Make_And_Apply_Values_To_Particle()
{
...
void CParticleSystem_Bush::Free()
{
