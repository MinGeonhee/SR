...
void ICam_Zoom::Enter(CCamera* pCamera, _vec3 vPos, _vec3 vDir, float fDistance, float fSpeed)
{
...
void ICam_Zoom::Update(CCamera* pCamera, CGameObject* pOwner, _float fDeltaTime)
{
...
void ICam_Zoom::Exit(CCamera* pCamera, CGameObject* pOwner)
{
	vEye = m_vStartEye;
	Set_eye(pCamera, pOwner);
	Set_Look(pCamera, pOwner);
...
void ICam_Zoom::Set_eye(CCamera* pCamera, CGameObject* pOwner)
{
...
void ICam_Zoom::Set_Look(CCamera* pCamera, CGameObject* pOwner)
{
	vLook = vEye + m_vZoomDir;
}

void ICam_Zoom::Set_Matview(CCamera* pCamera, CGameObject* pOwner)
{
	_matrix MatView;
...
void ICam_Zoom::Set_MatProj(CCamera* pCamera, CGameObject* pOwner)
{
	_matrix MatProj;
